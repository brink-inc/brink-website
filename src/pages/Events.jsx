...
// All images now load from PUBLIC folder
const eventImages = Array.from({ length: 20 }, (_, i) => {
  const num = String(i + 24).padStart(4, "0"); // 0024 → 0043
  return `/assets/IMG-20251125-WA${num}.jpg`;
});
  ...
  return (
    <div
      className={`min-h-screen transition-all duration-500 ${
        isDarkMode ? "bg-[#2C2C2C] text-white" : "bg-white text-[#2C2C2C]"
      } pt-20`}
    >
        ...
        <motion.div initial="hidden" animate="visible" variants={containerVariants}>
          ...
          <motion.div variants={itemVariants} className="mb-16">
            ...
            >
              ...
              >
                A one-day transformational experience featuring keynote speakers,
                young leaders' roundtable, breakout sessions, and
                community-building.
              </p>
              ...
              <Link to="/contact">
                <motion.button
                  whileHover={{ y: -2 }}
                  whileTap={{ scale: 0.98 }}
                  className="bg-[#D4AF37] hover:bg-[#B8941F] text-black px-8 py-3 rounded-lg text-sm uppercase tracking-wider font-semibold transition-all duration-300"
                >
                  Register Now
                </motion.button>
              </Link>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <p className={isDarkMode ? "text-white/80" : "text-[#2C2C2C]"}>
                  Regular gatherings where students share experiences, challenges,
                  and insights with peers and mentors.
                </p>
              </motion.div>
              ...
              >
                ...
                <p className={isDarkMode ? "text-white/80" : "text-[#2C2C2C]"}>
                  Monthly workshops covering leadership skills, emotional
                  intelligence, and purpose discovery.
                </p>
              </motion.div>
            </div>
          </motion.div>
